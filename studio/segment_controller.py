...
(``napari_app.core.predict_controller.PredictController``, ``analysis``,
...
class SegmentController:
    ...
    def _pc(self):
        if self.__predict_controller is None:
            from napari_app.core.predict_controller import PredictController
            self.__predict_controller = PredictController()
        return self.__predict_controller

    @staticmethod
    def _ensure_engines_registered() -> None:
        import napari_app.engines  # noqa: F401 — registers cellseg1 + cellpose
        import napari_app.engines_sam2  # noqa: F401 — registers sam2
    ...
    def list_available_engines(self) -> list[tuple[str, str, bool]]:
        ...
        from napari_app.engine_registry import all_engines
    ...
    def load_preview_image(image_path: str | Path) -> np.ndarray:
        ...
        from napari_app.core.predict_controller import _read_for_predict
