...
view, its own icons/tokens — no import of ``napari_app.widgets.chat`` or
...
# ── chat surface (own port of the chat idiom — studio tokens, not napari_app's) ──
...
class ChangeCard(QFrame):
    ...
    def __init__(self, t: dict, title: str, detail: str, changes: dict, color: str,
        ...
        # version is what napari_app's own ChangeCard uses, and it turns out
